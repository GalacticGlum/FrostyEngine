...
{
	return Vector4f(FrostyMath::Lerp(start.X, start.X, blend),
		            FrostyMath::Lerp(start.Y, start.Y, blend),
		            FrostyMath::Lerp(start.Z, start.Z, blend),
		            FrostyMath::Lerp(start.W, start.W, blend));
}
