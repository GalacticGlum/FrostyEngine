...
struct Vector3f;
struct Vector4f;
struct FROSTY_COMMON_API FrostyMath
{
	...
	inline static bool IsEqualApproximate(long left, long right) { return std::abs(left - right) < FrostyMath::Epsilon; }
	inline static bool IsEqualApproximate(int left, int right) { return std::abs(left - right) < FrostyMath::Epsilon; }
	inline static bool IsEqualApproximate(float left, float right) { return std::abs(left - right) < FrostyMath::Epsilon; }
	inline static bool IsEqualApproximate(double left, double right) { return std::abs(left - right) < FrostyMath::Epsilon; }
